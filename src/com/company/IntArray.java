...
public class IntArray implements Iterable<Integer> {
    ...
    //To get/ set values without method call overhead you can do array_obj.arr[index] instead,
    //you can gain about 10x the speed!
    ...
    //Removes the element ar the specified index in this list.
    ...
    //Search and remove and element if it is found in the array
    //If possible, avoid calling this method as it take O(n) time
    ...
    public int binarySearch(int key){
        ...
        //If not found this will tell you where to insert
        return index;
    ...
    //Iterator is still fast but not as fast as iteraive for loop
    @Override
